We're verifying the implementation of Show Nearby Store Markers by running verification for tasks under the frontend-verifier role's purview.
...
Read @agent-os/specs/2025-11-26-show-nearby-store-markers/spec.md to understand the context for this spec and where these tasks fit into it.
...
5. **(if applicable) view the implementation in a browser:** If your verification purview involves UI implementations, open a browser to view, verify and take screenshots and store screenshot(s) in `agent-os/specs/2025-11-26-show-nearby-store-markers/verification/screenshots`.
...
7. **Verify that implementations have been documented:** Verify that the implementer agent(s) have documented their work in this spec's `agent-os/specs/2025-11-26-show-nearby-store-markers/implementation`. folder.
8. **Document your verification report:** Write your verification report in this spec's `agent-os/specs/2025-11-26-show-nearby-store-markers/verification`. folder.
